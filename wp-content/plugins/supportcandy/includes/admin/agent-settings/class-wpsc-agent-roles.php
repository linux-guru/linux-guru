	...
	final class WPSC_Agent_Roles {
								...
								buttons: [
									{
										...
										action: function ( e, dt, node, config ) {
											wpsc_show_modal();
											var data = { action: 'wpsc_get_add_agent_role' };
											jQuery.post(
		...
		public static function get_add_agent_role() {
			...
			<form action="#" onsubmit="return false;" class="frm-add-agent-role">
				...
				<div class="wpsc-input-group">
					<div class="label-container">
						<label for=""><?php esc_attr_e( 'View Tickets', 'supportcandy' ); ?></label>
					</div>
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" value="view-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="view-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="view-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					<div class="label-container">
						<label for=""><?php esc_attr_e( 'Reply Tickets', 'supportcandy' ); ?></label>
					</div>
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" value="reply-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="reply-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="reply-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					<div class="label-container">
						<label for=""><?php esc_attr_e( 'Private Notes', 'supportcandy' ); ?></label>
					</div>
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" value="pn-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="pn-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="pn-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					<div class="label-container">
						<label for=""><?php esc_attr_e( 'Assign Agents', 'supportcandy' ); ?></label>
					</div>
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" value="aa-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="aa-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="aa-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					<div class="label-container">
						<label for=""><?php esc_attr_e( 'Change Status', 'supportcandy' ); ?></label>
					</div>
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" value="cs-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="cs-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="cs-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					<div class="label-container">
						<label for=""><?php esc_attr_e( 'Change Ticket Fields', 'supportcandy' ); ?></label>
					</div>
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" value="ctf-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="ctf-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="ctf-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					<div class="label-container">
						<label for=""><?php esc_attr_e( 'Change Agent Only Fields', 'supportcandy' ); ?></label>
					</div>
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" value="caof-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="caof-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="caof-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					<div class="label-container">
						<label for=""><?php esc_attr_e( 'Change Raised By', 'supportcandy' ); ?></label>
					</div>
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" value="crb-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="crb-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="crb-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					<div class="label-container">
						<label for=""><?php esc_attr_e( 'Modify Additional Recipients', 'supportcandy' ); ?></label>
					</div>
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" value="ar-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="ar-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="ar-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					<div class="label-container">
						<label for=""><?php esc_attr_e( 'Edit Threads', 'supportcandy' ); ?></label>
					</div>
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" value="eth-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="eth-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="eth-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					<div class="label-container">
						<label for=""><?php esc_attr_e( 'Delete Threads', 'supportcandy' ); ?></label>
					</div>
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" value="dth-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="dth-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="dth-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					<div class="label-container">
						<label for=""><?php esc_attr_e( 'View Logs', 'supportcandy' ); ?></label>
					</div>
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" value="vl-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="vl-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="vl-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					<div class="label-container">
						<label for=""><?php esc_attr_e( 'Delete Ticket', 'supportcandy' ); ?></label>
					</div>
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" value="dtt-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="dtt-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" value="dtt-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				...
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							...
							<span><?php esc_attr_e( 'WP dashboard accees', 'supportcandy' ); ?></span>
						</div>
						<div>
			...
			<?php
			do_action( 'wpsc_get_add_agent_role_footer' );
			$footer = ob_get_clean();
		...
		public static function get_edit_agent_role() {
			...
			$title = esc_attr__( 'Edit role', 'supportcandy' );
			...
			<form action="#" onsubmit="return false;" class="frm-edit-agent-role">
				...
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['view-unassigned'], 1 ); ?> value="view-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['view-assigned-me'], 1 ); ?> value="view-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['view-assigned-others'], 1 ); ?> value="view-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['reply-unassigned'], 1 ); ?> value="reply-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['reply-assigned-me'], 1 ); ?> value="reply-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['reply-assigned-others'], 1 ); ?> value="reply-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['pn-unassigned'], 1 ); ?> value="pn-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['pn-assigned-me'], 1 ); ?> value="pn-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['pn-assigned-others'], 1 ); ?> value="pn-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['aa-unassigned'], 1 ); ?> value="aa-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['aa-assigned-me'], 1 ); ?> value="aa-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['aa-assigned-others'], 1 ); ?> value="aa-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['cs-unassigned'], 1 ); ?> value="cs-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['cs-assigned-me'], 1 ); ?> value="cs-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['cs-assigned-others'], 1 ); ?> value="cs-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['ctf-unassigned'], 1 ); ?> value="ctf-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['ctf-assigned-me'], 1 ); ?> value="ctf-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['ctf-assigned-others'], 1 ); ?> value="ctf-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['caof-unassigned'], 1 ); ?> value="caof-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['caof-assigned-me'], 1 ); ?> value="caof-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['caof-assigned-others'], 1 ); ?> value="caof-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['crb-unassigned'], 1 ); ?> value="crb-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['crb-assigned-me'], 1 ); ?> value="crb-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['crb-assigned-others'], 1 ); ?> value="crb-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['ar-unassigned'], 1 ); ?> value="ar-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['ar-assigned-me'], 1 ); ?> value="ar-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['ar-assigned-others'], 1 ); ?> value="ar-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['eth-unassigned'], 1 ); ?> value="eth-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['eth-assigned-me'], 1 ); ?> value="eth-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['eth-assigned-others'], 1 ); ?> value="eth-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['dth-unassigned'], 1 ); ?> value="dth-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['dth-assigned-me'], 1 ); ?> value="dth-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['dth-assigned-others'], 1 ); ?> value="dth-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['vl-unassigned'], 1 ); ?> value="vl-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['vl-assigned-me'], 1 ); ?> value="vl-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['vl-assigned-others'], 1 ); ?> value="vl-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
				<div class="wpsc-input-group">
					...
					<div class="checkbox-group">
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['dtt-unassigned'], 1 ); ?> value="dtt-unassigned">
							<span><?php esc_attr_e( 'Unassigned', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['dtt-assigned-me'], 1 ); ?> value="dtt-assigned-me">
							<span><?php esc_attr_e( 'Assigned to me', 'supportcandy' ); ?></span>
						</div>
						<div>
							<input name="caps[]" type="checkbox" <?php checked( $role['caps']['dtt-assigned-others'], 1 ); ?> value="dtt-assigned-others">
							<span><?php esc_attr_e( 'Assigned to others', 'supportcandy' ); ?></span>
						</div>
					</div>
				</div>
			...
			ob_start();
			?>
			<button class="wpsc-button small primary" onclick="wpsc_set_edit_agent_role(this);">
				<?php esc_attr_e( 'Submit', 'supportcandy' ); ?>
			</button>
			<button class="wpsc-button small secondary" onclick="wpsc_close_modal();">
				<?php esc_attr_e( 'Cancel', 'supportcandy' ); ?>
			...
			<?php
			do_action( 'wpsc_get_edit_agent_role_footer' );
			$footer = ob_get_clean();
