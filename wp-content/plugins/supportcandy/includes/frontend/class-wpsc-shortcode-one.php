					...
					if ( self::$sections ) {
						...
						<div class="wpsc-header wpsc-hidden-xs">
							...
							foreach ( self::$sections as $key => $section ) :
								...
								?>
								<div class="wpsc-tickets-nav <?php echo esc_attr( $key ) . ' ' . esc_attr( $active ); ?>" onclick="<?php echo esc_attr( $section['callback'] ) . '();'; ?>">
							...
							endforeach;
							?>
							<div class="wpsc-tickets-nav log-out" onclick="wpsc_user_logout(this, '<?php echo esc_attr( wp_create_nonce( 'wpsc_user_logout' ) ); ?>');">
			...
			<script type="text/javascript">
				...
				function wpsc_get_ticket_list(is_humbargar = false) {
					...
					if (wpsc_is_description_text()) {
						if (!confirm(supportcandy.translations.warning_message)) return; else {
