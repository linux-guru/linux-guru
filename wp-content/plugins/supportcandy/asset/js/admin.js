...
function wpsc_set_gs_thankyou(el) {
	...
	var dataform    = new FormData( form );
	var is_tinymce  = (typeof tinyMCE != "undefined") && tinyMCE.activeEditor && ! tinyMCE.activeEditor.isHidden();
	var description = is_tinymce ? tinyMCE.activeEditor.getContent().trim() : jQuery( '#thankyou-html' ).val();
	dataform.append( 'thankyou-html', description );
 ...
 */
function wpsc_en_clone_ticket_notification(template_id, nonce) {

	var data = { action: 'wpsc_en_clone_ticket_notification', template_id, _ajax_nonce: nonce };
	jQuery.post(
		supportcandy.ajax_url,
		data,
		function (response) {
 ...
 */
function wpsc_get_ms_rest_api() {

	supportcandy.current_tab = 'rest-api';
	jQuery( '.wpsc-setting-tab-container button' ).removeClass( 'active' );
	jQuery( '.wpsc-setting-tab-container button.' + supportcandy.current_tab ).addClass( 'active' );
	...
	var data = { action: 'wpsc_get_ms_rest_api' };
	jQuery.post(
		supportcandy.ajax_url,
		data,
		function (response) {
 ...
 * @param {*} el
 */
function wpsc_set_ms_rest_api(el) {

	var form     = jQuery( '.wpsc-frm-ms-rest-api' )[0];
	var dataform = new FormData( form );
	jQuery( '.wpsc-modal-footer button' ).attr( 'disabled', true );
	jQuery( el ).text( supportcandy.translations.please_wait );
	jQuery.ajax(
 ...
 * @param {*} el
 */
function wpsc_reset_ms_rest_api(el, nonce) {

	jQuery( '.wpsc-modal-footer button' ).attr( 'disabled', true );
	jQuery( el ).text( supportcandy.translations.please_wait );
	var data = { action: 'wpsc_reset_ms_rest_api', _ajax_nonce: nonce };
	jQuery.post(
		supportcandy.ajax_url,
		data,
		function (response) {
