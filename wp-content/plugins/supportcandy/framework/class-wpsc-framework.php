...
if ( ! class_exists( 'WPSC_Framework' ) ) :
	...
	final class WPSC_Framework {
		...
		public static function localizations( $localizations ) {
			...
			$localizations['translations']['req_fields_missing']    = esc_attr__( 'Requied fields missing!', 'supportcandy' );
			...
			$localizations['translations']['warning_message']       = esc_attr__( 'There is unposted text in the reply area. Are you sure you want to discard and proceed?', 'supportcandy' );
