						...
						<div id="bdpstandard" class="postbox postbox-with-fw-options" <?php echo $bdpstandard_class_show; //phpcs:ignore ?>>
							<ul class="bd-settings">
								...
								<li class="blog-sallet-slider-tr">
									<div class="bd-left">
										<span class="bd-key-title">
											<?php echo esc_html_e( 'Display Blog Content in ', 'blog-designer' ); ?>
										</span>
									</div>
									<div class="bd-right">
										<span class="fas fa-question-circle bd-tooltips-icon bd-tooltips-icon-color"><span class="bd-tooltips"><?php esc_html_e( 'Select column for post', 'blog-designer' ); ?></span></span>
								...
								<li class="ticker_label_tr">
									...
									<div class="bd-right">
										...
										$ticker_label = esc_html__( 'Latest Blog', 'blog-designer' );//phpcs:ignore
										if ( isset( $settings['ticker_label'] ) ) {
											$orderby = $settings['ticker_label']; //phpcs:ignore
										}
										?>
							...
							<ul class="bd-settings">
								<li>
									...
									<div class="bd-right">
										...
										if ( isset( $settings['pagination_type'] ) && '' != $settings['pagination_type'] ) { //phpcs:ignore
								...
								<li class="loadmore_btn_option">
									...
									<div class="bd-right">
										...
										<?php $loadmore_button_text = ( isset( $settings['loadmore_button_text'] ) && '' != $settings['loadmore_button_text'] ) ? $settings['loadmore_button_text'] : esc_html__( 'Load More', 'blog-designer' ); //phpcs:ignore ?>
