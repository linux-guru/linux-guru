...
class Miniorange_API_Authentication_Admin {
	...
	function save_temporary_data(){
		update_option('mini_00',$_POST['nonce']);
		if (sanitize_text_field($_SERVER['REQUEST_METHOD']) === 'POST' &&  current_user_can('administrator') && wp_verify_nonce($_POST['nonce'] , 'mo_rest_api_temporal_data_nonce' ) ) {
